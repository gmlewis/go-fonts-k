...
import (
  ...
  _ "github.com/gmlewis/go-fonts-k/fonts/konstytucyja"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from konstytucyja"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "konstytucyja", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
