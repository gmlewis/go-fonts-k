...
import (
  ...
  _ "github.com/gmlewis/go-fonts-k/fonts/kingthingsitalique"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from kingthingsitalique"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "kingthingsitalique", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
