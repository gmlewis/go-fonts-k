module github.com/gmlewis/go-fonts-k/fonts/kingthingsitalique

go 1.25.0

require github.com/gmlewis/go-fonts v0.20.0
...
replace github.com/gmlewis/go-fonts v0.20.0 => ../../../go-fonts/
